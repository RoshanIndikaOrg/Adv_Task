...
namespace MARS_ADV_Task.Pages
{
    internal class Managelistings : Commondriver
    {
        ...
        {
            Wait.WaitForvisible(driver, "CssSelector", "#listing-management-section > div:nth-child(3) > div:nth-child(2) > div:nth-child(1) > table > tbody > tr:nth-child(1) > td:nth-child(3)", 2);
